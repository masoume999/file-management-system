...
if(isset($_POST['submit']))
{
    ...
    $sql = "SELECT * FROM  files WHERE subject like '%$search%' or tag1 like '%$search%' or tag2 like '%$search%' or category like '%$search%' or author_id like '%$search%' or sharing='2' AND file_id=(SELECT file_id FROM file_access WHERE user_id='$user_id')";
