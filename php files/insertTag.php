...
if(isset($_POST['insert'])){
  ...
  if($subject == null){
    echo "<script>alert('عنوان برچسب را وارد نمایید.');</script>";
  }
  else{
    $stmt = $con->prepare("INSERT INTO tag (subject,user_id) VALUES ('$subject','$author_id')");
    $stmt->execute();
    $stmt->close();

    echo "<script>alert('برچسب با موفقیت ثبت شد.');</script>";
  ...
  <body>
    <form class="signup-form" method="post" enctype="multipart/form-data">
      ...
      <div class="form-header">
        <div class="text">عنوان برچسب را وارد نمایید.</div>
      </div>
      ...
      <div class="form-body">
        ...
        <div class="form-group">
            <label for="filename" class="label-title">عنوان برچسب:</label>
