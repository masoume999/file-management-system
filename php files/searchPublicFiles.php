...
if(isset($_POST['submit']))
{
    ...
    $sql = "SELECT * FROM  files WHERE subject like '%$search%' or tag1 like '%$search%' or tag2 like '%$search%' or category like '%$search%' or author_id like '%$search%' AND sharing='1'";
